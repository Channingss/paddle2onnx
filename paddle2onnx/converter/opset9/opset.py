...
from paddle2onnx.onnx.utils import DTYPE_MAP, get_name, make_constant_node
...
def bilinear_interp(op, block):
    ...
    if ('OutSize' in input_names and len(op.input('OutSize')) > 0) or (
        ...
        shape_name2 = get_name(op.type, "shape.concat")
        ...
        cast_shape_name2 = get_name(op.type, "shape.cast")
        ...
        cast_shape_name0 = get_name(op.type, "shape.cast")
