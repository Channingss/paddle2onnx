...
class NaiveLogger : public nvinfer1::ILogger {
 public:
    NaiveLogger(Severity severity = Severity::kWARNING)
...
class TensorRTInferenceEngine {
 public:
  void Init(std::string model_dir, int max_workspace_size, int max_batch_size, std::string trt_cache_filebool="", TensorRTInferenceConfigs configs=TensorRTInferenceConfigs());
